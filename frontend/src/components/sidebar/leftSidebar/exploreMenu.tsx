// src/components/LeftSidebar/ExploreMenu.tsx
...
interface ExploreMenuItem {
  ...
  badge?: string; // Optional "New" badge
  className?: string; // Optional additional classes
}

// Menu items data - easy to add/modify items
    ...
    <div className="_left_inner_area_explore _padd_t24 _padd_b6 _padd_r24 _padd_l24 _b_radious6 _feed_inner_area">
      ...
      <ul className="_left_inner_area_explore_list">
        {exploreMenuItems.map((item) => (
          <li
            key={item.id}
            className={item.className ? `_left_inner_area_explore_item ${item.className}` : '_left_inner_area_explore_item'}
          >
            <p className="_left_inner_area_explore_link" style={{ cursor: 'pointer' }} >
              {item.icon}
              {item.label}
            </p>
