...
import {ProfileDropdown} from './profileDropdown' // if you want to merge later
...
export const NavIcons: React.FC = () => {
  ...
  return (
    <ul className="navbar-nav mb-2 mb-lg-0 _header_nav_list ms-auto _mar_r8">
      ...
      {/* Notifications */}
      <li className="nav-item _header_nav_item position-relative" ref={notifyRef}>
        <div
      ...
      {/* Messenger */}
      <li className="nav-item _header_nav_item position-relative" ref={messengerRef}>
        <div
        ...
        {showMessenger && (
          <div className="_messenger_dropdown" style={{
            position: 'absolute',
            top: '100%',
            right: 0,
            width: '380px',
            ...
            <div className="p-3 border-bottom d-flex justify-content-between align-items-center">
              ...
              <button className="btn btn-link text-muted">See all</button>
            </div>
